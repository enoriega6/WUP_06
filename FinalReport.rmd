...
With the samller data there are still more whites who are in favor of cappun, compared to blacks.  
...
Here with small data, the blacks are closer to 50/50 in favor or oppose to cappun. The whites, again are shown to favor cappun.
...
```
With the smaller data, we don't seem to have enough evidence of statistical difference in attitude toward cappun. Only blacks and whites have a significant difference on cappun.

# Discussion and Conclusion

<!--Discussion and conclusion here.  If you found a relationship be sure to consider whether the relationship occurs because one of the variavbles causes the other, or whether they perhasps are related for some other reason.  Watch the chapter 6 videos from the GeorgeTown videos collection.!-->

In the small data there is a difference in attitude towards cappun.The difference is only shown between blacks and whites in the tables shown above.