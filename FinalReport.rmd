...
Fisher xy test gives us a p-value= 0.00001741
There is significant difference in attitude towards cappun based on race,between whites and blacks only. Hence it's less than 0.05.
...
The null hypothesis will be rejected due p-value being less than 0.05, which is 0.001564, based on the fisher xy test. What this means there is a difference is based on race whether or not they are in favor of cappun.
With the smaller data, we don't seem to have enough evidence of statistical difference in attitude toward cappun based on race.  
